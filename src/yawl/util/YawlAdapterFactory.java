...
public class YawlAdapterFactory extends AdapterFactoryImpl {
	...
	protected YawlSwitch<Adapter> modelSwitch =
		new YawlSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTypeOfCondition(TypeOfCondition object) {
				return createTypeOfConditionAdapter();
			}
			@Override
			public Adapter caseTypeOfTransition(TypeOfTransition object) {
				return createTypeOfTransitionAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseTypeOfArc(TypeOfArc object) {
				return createTypeOfArcAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link yawl.TypeOfCondition <em>Type Of Condition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link yawl.TypeOfTransition <em>Type Of Transition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link yawl.TypeOfArc <em>Type Of Arc</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link yawl.YawlNetArcAnnotation <em>Net Arc Annotation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

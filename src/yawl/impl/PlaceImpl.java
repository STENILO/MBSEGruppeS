...
public class PlaceImpl extends org.pnml.tools.epnk.pnmlcoremodel.impl.PlaceImpl implements Place {
	 ...
	 * @ordered
	 */
	protected TypeOfCondition type;
	 ...
	 * @generated
	 */
	public TypeOfCondition getType() {
		return type;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetType(TypeOfCondition newType, NotificationChain msgs) {
		TypeOfCondition oldType = type;
		type = newType;
	 ...
	 * @generated
	 */
	public void setType(TypeOfCondition newType) {
		if (newType != type) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case YawlPackage.PLACE__TYPE:
				setType((TypeOfCondition)newValue);
				return;
		}
